#ifndef SPACEROCKS_HIGHSCORE_H
#define SPACEROCKS_HIGHSCORE_H

#include <Arduino.h>

#define HS_NAME_LIMIT 3 // player name character limit
#define HS_MAX_SCORES 5 // # of players in HS
#define HS_FILENAME "/SpaceRocks" // SPIFFS filename for the HS, max 31 char
